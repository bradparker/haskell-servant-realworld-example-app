...
app conn = serveWithContext api serverAuthContext (server conn)
  where
    serverAuthContext ::
         Context (AuthHandler Request DBUser ': AuthHandler Request (Maybe DBUser) ': '[])
    serverAuthContext =
...
type API
   ...
   = "api" :> "users" :> "login" :> ReqBody '[ JSON] (User Login) :> Post '[ JSON] (User AuthUser)
      ...
      :<|> "api" :> "users" :> ReqBody '[ JSON] (User NewUser) :> Post '[ JSON] (User (Maybe AuthUser))
         -- | Get Current User
      :<|> "api" :> "user" :> AuthProtect "JWT" :> Get '[ JSON] (User AuthUser)
         -- | Update User
      :<|> "api" :> "user" :> AuthProtect "JWT" :> ReqBody '[ JSON] (User UpdateUser) :> Put '[ JSON] (User AuthUser)
         -- | Profile Get
      :<|> "api" :> "profiles" :> Capture "username" Username :> AuthProtect "JWT-optional" :> Get '[ JSON] (Profile (Maybe UserProfile))
         -- | Follow
      :<|> "api" :> "profiles" :> Capture "username" Username :> "follow" :> AuthProtect "JWT" :> Post '[ JSON] (Profile (Maybe UserProfile))
        -- | Unfollow
      :<|> "api" :> "profiles" :> Capture "username" Username :> "follow" :> AuthProtect "JWT" :> Delete '[ JSON] (Profile (Maybe UserProfile))
        -- | List Article
      :<|> "api" :> "articles" :> QueryParam "limit" Limit :> QueryParam "offset" Offset :> QueryParam "author" Author :> QueryParam "tag" Tagged :> QueryParam "favourited" FavoritedBy :> AuthProtect "JWT-optional" :> Get '[ JSON] (Arts [Article])
        -- | Feed Article
      :<|> "api" :> "articles" :> "feed" :> QueryParam "limit" Limit :> QueryParam "offset" Offset :> AuthProtect "JWT" :> Get '[ JSON] (Arts [Article])
        -- | Get Article
      :<|> "api" :> "articles" :> Capture "slug" Text :> Get '[ JSON] (Art (Maybe Article))
        -- | Create Article
      :<|> "api" :> "articles" :> AuthProtect "JWT" :> ReqBody '[ JSON] (Art NewArticle) :> Post '[ JSON] (Art Article)
        -- | Update Article
      :<|> "api" :> "articles" :> Capture "slug" Text :> AuthProtect "JWT" :> ReqBody '[ JSON] (Art UpdateArticle) :> Put '[ JSON] (Art (Maybe Article))
        -- | Delete Article
      :<|> "api" :> "articles" :> Capture "slug" Text :> AuthProtect "JWT" :> Delete '[ JSON] ()
        -- | Add Comments to an Article
      :<|> "api" :> "articles" :> Capture "slug" Text :> "comments" :> AuthProtect "JWT" :> ReqBody '[ JSON] (Cmt NewComment) :> Post '[ JSON] (Cmt Comment)
        -- | Get Comments from an Article
      :<|> "api" :> "articles" :> Capture "slug" Text :> "comments" :> AuthProtect "JWT-optional" :> Get '[ JSON] (Cmts [Comment])
        -- | Delete Comment
      :<|> "api" :> "articles" :> Capture "slug" Text :> "comments" :> Capture "id" Int :> AuthProtect "JWT" :> Delete '[ JSON] ()
        -- | Favorite Article
      :<|> "api" :> "articles" :> Capture "slug" Text :> "favorite" :> AuthProtect "JWT" :> Post '[ JSON] (Art Article)
        -- | Unfavorite Article
      :<|> "api" :> "articles" :> Capture "slug" Text :> "favorite" :> AuthProtect "JWT" :> Delete '[ JSON] (Art Article)
        -- | Get Tags
      :<|> "api" :> "tags" :> Get '[ JSON] (TagList [Text])
...
server conn =
  loginHandler conn :<|> registerHandler conn :<|> getUserHandler conn :<|>
...
type instance AuthServerData (AuthProtect "JWT-optional") =
     (Maybe DBUser)
        ...
        case lookup "Authorization" (requestHeaders req) of
          ...
          Just token ->
            case decodeToken token of
              Nothing -> return Nothing
              Just username -> liftIO $ dbGetUserByName conn username
...
decodeToken auth
 ...
 =
  let auth' = decodeUtf8 auth
      ...
      json =
        Map.lookup "username" =<< fmap (JWT.unregisteredClaims . JWT.claims) jwt
  ...
  JWT.encodeSigned
    ...
    JWT.def
      { JWT.unregisteredClaims =
          Map.singleton "username" . toJSON $ User username
      }
...
updateUserHandler ::
     Connection -> DBUser -> User UpdateUser -> Handler (User AuthUser)
...
getProfileHandler ::
  ...
  -> Username
  -> Maybe DBUser
  -> Handler (Profile (Maybe UserProfile))
getProfileHandler conn name mbRequestee
  -- TODO follows
 = do
...
followHandler ::
     Connection -> Username -> DBUser -> Handler (Profile (Maybe UserProfile))
...
createArticleHandler ::
     Connection -> DBUser -> Art NewArticle -> Handler (Art Article)
...
listArticlesHandler conn mbLimit mbOffset mbAuthor mbTag mbFavBy mbUser = do
  ...
  articles <-
    liftIO $ dbGetArticles conn limit offset mbAuthor mbTag mbFavBy mbUser
...
addCommentHandler ::
     Connection -> Text -> DBUser -> Cmt NewComment -> Handler (Cmt Comment)
...
getCommentsHandler ::
     Connection -> Text -> Maybe DBUser -> Handler (Cmts [Comment])
...
unfavoriteArticleHandler ::
     Connection -> Text -> DBUser -> Handler (Art Article)
